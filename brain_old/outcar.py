...
def get_volume_vectors(look_vectors=look_vectors):
...
def get_kpoints(look_kpoints=look_kpoints):
    line_kpoints = dict_line.get(look_kpoints)[0]
    kpoints      = lines_o[line_kpoints].split()[1]
    return  kpoints
#print(get_kpoints())

def get_position(look_position = look_position):
