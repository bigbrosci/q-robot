...
### SPIN & MAG
mag_value = { 
    'Ag': 0.0, 'Cu': 1.0, 'Fe': 3.0, 'Ir': 1.0, 'Ni': 1.0, 'Pd': 1.0,
    'Pt': 0.0, 'Rh': 1.0, 'Co': 2.0, 'Ru': 1.0, 'Os': 1.0, 'Au': 0.0,
    'Ti': 0.0, 'Zn': 0.0, 'Sn': 0.0, 'O': 0.0,  'Cr': 4.0, 'Mo': 1.0,
    # O  default magnetization 
}
...
def spin_update(ispin):
    ...
    for symbol, count in element_counts.items():
        magmom_per_atom = mag_value.get(symbol, 1.0)
